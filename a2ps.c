...
char *name;
{
	...
	first_page = FALSE;
	if (!print_binaries && (nonprinting_chars*100 / chars) >= 60)
	{
...
#ifdef LPR_OPT
	    execlp(LPR_COMMAND, LPR_COMMAND, LPR_OPT, lpr_opt, (char *)0);
#else
	    execlp(LPR_COMMAND, LPR_COMMAND, lpr_opt, (char *)0);
#endif
